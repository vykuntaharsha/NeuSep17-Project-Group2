...
import MainFrame.FilterPanel;
import MainFrame.SearchPanel;
...
public class DealerMainWindow extends JFrame implements Runnable {
    ...
    public DealerMainWindow() throws IOException {
        invsAPI = new InventoryServiceAPI_Test("/Users/tingyuanzhang/Downloads/NeuSep17-Project-Group2-master 3/data/gmps-blue-ribbon");
...
//            if(currentVehicleList.get(i).getId().equals(searchedVehicles.get(i).getId())){
//                System.out.println("???????????????????");
//            }
//        }
