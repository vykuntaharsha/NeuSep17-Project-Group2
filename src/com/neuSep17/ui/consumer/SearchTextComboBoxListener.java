...
public class SearchTextComboBoxListener extends KeyAdapter {
    ...
    public SearchTextComboBoxListener(JComboBox searchTextComboBox, HashSet<String> dictionary, SearchPanel searchPanel) {
    ...
    public void keyReleased(KeyEvent key){
        ...
        if (filteredVector.size() != 0) {
            ...
            popup.setLocation(searchTextComboBox.getLocationOnScreen().x + 3, searchTextComboBox.getLocationOnScreen().y + 48);
